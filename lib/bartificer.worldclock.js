 ...
 * @{link bartificer.Worldclock}. A clock can be auto-generated when the DOM
 * becomes ready by adding the class `bartificer-worldclock-auto` to a `span`
 * `div`, paragraph (`p`) or heading (`h1`, `h2` ...).
 *
...
(function(bartificer, $, undefined){
     ...
     * @param {boolean} [options.showAmpm=false] Whether or not to show the
